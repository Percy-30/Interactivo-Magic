...
<body>
    ...
    <div class="card-container">
        ...
        <div class="main-title">{{template_title}}</div>
        
        <div class="photo-frame">
            <img src="{{image_src}}" alt="Cumpleañero" onerror="this.parentElement.style.display='none'">
        </div>
    ...
    <script>
        ...
        function startFireworks() {
            ...
            const particles = [];
            const colors = ['#ff6b00', '#00f2ff', '#ffffff'];
            ...
            animate();
            confetti({ particleCount: 150, spread: 80, origin: { y: 0.6 }, colors: ['#ff6b00', '#00f2ff'] });
        }
    </script>
</body>
</html>`;
