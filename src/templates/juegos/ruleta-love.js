...
<head>
    ...
    <style>
        ...
        .game-header h1 { font-size: 2.22rem; font-weight: 900; color: var(--text); margin: 0; line-height: 1.2; }
...
<body>
    ...
    <div id="intro-overlay" onclick="startExperience()">
        <div style="text-align: center;">
            ...
            <div style="font-size: 1.88rem; font-weight: 900; color: var(--text); margin-top: 1.5rem;">RULETA DEL AMOR</div>
